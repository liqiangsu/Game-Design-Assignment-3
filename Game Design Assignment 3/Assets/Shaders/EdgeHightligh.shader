Shader "Custom/EdgeHightligh" {
Properties { _MainTex ("Base (RGB)", 2D) = "white" {} _Treshold ("Treshold", Float) = 0.2 }
...
uniform sampler2D _MainTex; uniform float4 _MainTex_TexelSize; uniform float _Treshold;
